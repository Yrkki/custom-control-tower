...
BUCKETS = {
    "aws-controltower-logs-640693977485-eu-west-1": lifecycle_rules(
        EXPIRATION_DAYS, NONCURRENT_DAYS, ABORT_MULTIPART_DAYS
    ),
    "aws-controltower-s3-access-logs-640693977485-eu-west-1": lifecycle_rules(
        EXPIRATION_DAYS, NONCURRENT_DAYS, ABORT_MULTIPART_DAYS
    ),
}
...
def assume_role():
    ...
    response = sts.assume_role(
        RoleArn=LOG_ACCOUNT_ROLE, RoleSessionName="lifecycle-enforcer"
    )
